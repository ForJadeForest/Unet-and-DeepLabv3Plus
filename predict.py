...
def set_args():
    ...
    parser.add_argument('--model_path', default='/home/guest/yxyuan/cvproject/run/unetrun_2/models/unet-voc_epoch-187.pth',
                        type=str, help='模型路径')
...
if __name__ == '__main__':
    ...
    testloader = DataLoader(voc_val, batch_size=12, shuffle=False, num_workers=0)
